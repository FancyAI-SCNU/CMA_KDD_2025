...
# from util.print_args import print_args
import random
import numpy as np
...
if __name__ == '__main__':
    ...
    parser.add_argument('--down_sampling_layers', type=int,
                        default=0, help='num of down sampling layers')
    parser.add_argument('--down_sampling_window', type=int,
                        default=1, help='down sampling window size')
