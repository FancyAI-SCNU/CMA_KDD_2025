...
class EncoderLayer(nn.Module):
    ...
    def forward(self, x, attn_mask=None, tau=None, delta=None, label_emb=None):
...
class ITransformer(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        d_ff = n_embd
        # Embedding
        self.enc_embedding = DataEmbedding_inverted(feat_len, n_embd, embed_type, freq,
                                                    dropout)
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec,):
        ...
        # input_mark = torch.concat([x_mark_enc,x_mark_dec[:,-self.pred_len:,:]],dim=1)
        # Embedding
