...
class EncoderLayer(nn.Module):
    ...
    def forward(self, x, attn_mask=None,label_emb=None):
    ...
    def forward(self, x, attn_mask=None,label_emb=None):
        ...
        if self.conv_layers is not None:
            for attn_layer, conv_layer in zip(self.attn_layers, self.conv_layers):
                x, attn = attn_layer(x, attn_mask=attn_mask,label_emb=None)
                x = conv_layer(x)
                attns.append(attn)
...
class DecoderLayer(nn.Module):
    ...
    def forward(self, x, cross ,x_mask=None, cross_mask=None,label_emb=None):
