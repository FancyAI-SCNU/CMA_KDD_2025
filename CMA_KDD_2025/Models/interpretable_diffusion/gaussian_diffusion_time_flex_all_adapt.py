...
from Models.interpretable_diffusion.TimeXer_pretrain import Model
...
class Diffusion_TS(nn.Module):
    def __init__(
        ...
        self.model = Model(n_feat=feature_size, seq_len=seq_length, feat_len=feat_len, n_layer_enc=n_layer_enc, n_layer_dec=n_layer_dec,
                           n_embd=d_model, n_heads=n_heads, attn_pdrop=attn_pd, resid_pdrop=resid_pd, mlp_hidden_times=mlp_hidden_times, **kwargs)
