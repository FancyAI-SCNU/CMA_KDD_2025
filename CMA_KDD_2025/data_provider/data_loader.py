...
class Dataset_Custom(Dataset):
    ...
    def __read_data__(self):
        ...
        self.data_x = self.data_x[self.adapt_num_step*self.his_interval:, :]
        self.data_y = self.data_y[self.adapt_num_step*self.his_interval:, :]
        self.data_stamp = data_stamp
...
class Dataset_PEMS(Dataset):
    ...
    def __read_data__(self):
        ...
        valid_data = data[int(train_ratio * len(data))
        ...
        df = df.fillna(method='ffill', limit=len(df)).fillna(
            method='bfill', limit=len(df)).values
